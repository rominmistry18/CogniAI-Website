...
const defaultCategories: FAQCategory[] = [
  {
    ...
    faqs: [
      ...
      {
        question: "Who is Cognaium designed for?",
      ...
      {
        question: "What makes Cognaium different from other HR platforms?",
      ...
      {
        question: "How does Cognaium use artificial intelligence?",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "The Composite Candidate Index (CCI) is Cognaium's proprietary pre-assessment scoring algorithm that evaluates candidates before formal interviews. CCI analyzes three dimensions: Resume-Job Match (how well skills and experience align with requirements), Role Readiness (indicators of immediate contribution potential), and Risk Factors (potential concerns or gaps). CCI scores help recruiters prioritize candidates efficiently, reducing time-to-hire while improving quality of hire."
      },
      {
        question: "Can I customize the AI interview experience?",
        answer: "Yes, Cognaium offers extensive customization for AI interviews. You can set the AI personality and tone, define specific competencies to assess, configure follow-up question depth, set time limits per question and overall assessment, add company-specific context and scenarios, choose which AI provider to use (GPT-4, Claude, or Gemini), and customize the candidate-facing interface with your branding."
      }
    ]
  },
  {
    ...
    faqs: [
      {
        question: "How does real-time proctoring work in Cognaium?",
  ...
  },
  {
    ...
    faqs: [
      {
        question: "What types of training content does Cognaium support?",
      ...
      },
      {
        ...
        answer: "Multi-Agent AI Tutoring is Cognaium's approach to personalized learning where multiple specialized AI agents collaborate: Curriculum Planner (designs personalized learning paths), Concept Explainer (breaks down complex topics in understandable terms), Practice Coach (guides hands-on exercises and provides feedback), and Quiz Generator (creates adaptive assessments). The agents coordinate to adapt to individual learning styles, pace, and knowledge gaps, providing a truly personalized learning experience with optional voice interaction."
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        question: "How do I create a certification program in Cognaium?",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: "What security certifications does Cognaium have?",
      ...
      {
        question: "Does Cognaium integrate with other HR systems?",
        answer: "Yes, Cognaium provides RESTful APIs for integration with existing HR systems. Common integrations include: HRIS systems (Workday, SAP SuccessFactors, BambooHR), ATS platforms for bi-directional candidate sync, SSO providers (Okta, Azure AD, OneLogin), calendar systems for interview scheduling, and custom integrations via webhooks. Our API documentation is available to customers, and our professional services team can assist with complex integration requirements."
      }
    ]
  },
  {
    ...
    faqs: [
      {
        question: "How is Cognaium priced?",
      ...
      },
      {
        ...
        answer: "Yes, Cognaium offers a 14-day free trial with full access to core platform features. The trial includes AI screening, basic proctoring, training creation, and limited AI usage credits. No credit card is required to start. Enterprise evaluations with extended trials and proof-of-concept support are available upon request."
      },
      {
...
const defaultContent: Required<FAQContentProps> = {
  header: {
...
export function FAQContent({ header, categories, support }: FAQContentProps) {
  ...
  const categoriesData = categories && categories.length > 0 ? categories : defaultContent.categories;
  const supportData = { ...defaultContent.support, ...support };

  // Flatten FAQs for schema
  const allFaqs = categoriesData.flatMap(cat => cat.faqs);
  ...
  return (
    <>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <p className="text-sm text-muted-foreground">Last Updated: {headerData.lastUpdated}</p>
          </div>
      ...
      <section className="py-16 bg-card/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href={supportData.primaryCtaLink || "/contact"}>
              <span className="px-6 py-3 rounded-lg bg-primary text-primary-foreground font-medium hover:bg-primary/90 transition-colors inline-block">
                {supportData.primaryCta}
              </span>
            </Link>
            <Link href={supportData.secondaryCtaLink || "/support"}>
