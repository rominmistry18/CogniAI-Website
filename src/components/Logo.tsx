        ...
        <img 
          ...
          onError={(e) => {
            ...
            if (parent) {
              ...
              svgContainer.innerHTML = `<svg width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-10 h-10"><defs><linearGradient id="logo-gradient-fallback" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#002F6C" /><stop offset="50%" stop-color="#007ACC" /><stop offset="100%" stop-color="#00C9D1" /></linearGradient></defs><path d="M75 25C65 15 50 10 35 15C20 20 10 35 10 50C10 65 20 80 35 85C50 90 65 85 75 75L65 65C60 70 50 75 40 70C30 65 25 55 25 50C25 45 30 35 40 30C50 25 60 30 65 35L75 25Z" fill="url(#logo-gradient-fallback)" /></svg>`;
              parent.insertBefore(svgContainer.firstChild!, target);
            }
          }}
        />
      ) : (
